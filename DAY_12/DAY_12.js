// ********JavaScriptmas_DAY-12_Challenge**********
...
const dinnerFoods = ["🍝", "🍔", "🌮"];
const menu = document.getElementById("menu"); //* Grabing the section which have id "menu"
//* Setting the innerHTML of the menu by mapping over each element of dinnerFoods, here join help to remove the commas.
menu.innerHTML = dinnerFoods
   .map((item, index) => `<div class="food">${item}</div>`)
   .join("");
